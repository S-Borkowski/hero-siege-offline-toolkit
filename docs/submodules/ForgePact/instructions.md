...
| `py -m unittest discover -s tests -v` | `ForgePact/` | PowerShell / CMD | Python 3.10+ | Executes all 171 Python contract tests. | Read-only test execution; all tests pass | Verified |
